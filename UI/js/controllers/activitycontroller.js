ehs.controller("ActivityController", function ($scope, $state, $rootScope, $stateParams) {
        ...
        options: {
            ...
            scales: {
                ...
                yAxes: [{
                    ...
                    scaleLabel: {
                        display: true,
                        labelString: 'Activity(Steps / day)'
                    },
                    ticks: {
                        suggestedMin: 0,
                        suggestedMax: 250,
